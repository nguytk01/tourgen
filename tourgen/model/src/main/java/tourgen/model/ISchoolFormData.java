...
public class ISchoolFormData {
	 ...
	 *            the school's enrollment number
	 * @param girlsPartcipationStatus
	 *            the school's participation status in girls' tournaments.
	 * @param boysParticipationStatus
	 *            the school's participation status in boys' tournaments.
	 */
	// @Deprecated
