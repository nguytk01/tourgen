...
class GoogleMapsApiHelper{
	...
	GoogleMapsApiHelper(){
		distanceMatrixContext = (new GeoApiContext.Builder()
			.apiKey(tourgen.model.GoogleMapsAPIKey.getGoogleDistanceMatrixApiKey()))
			.build();
