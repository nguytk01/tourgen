...
public class CheckBoxTreePanel extends JPanel {
	public CheckBoxTreePanel(CheckBoxTreeCustomCheckBoxListener checkBoxListener, Repository repo, MapController controller) {
	    String[] strs = {"Tournament 2017-18",
	    		"Tournaments",// 0
	         "Sectionals",     // 1
	         "Regionals",     // 2
	         "Semi-State",     // 3
			    	...
			    	for(int meetIndex = 0; meetIndex < stage.getListMeet().size(); meetIndex++)
				        {
			    			...
			    			//for (int schoolIndex = 0; schoolIndex < meet.getParticipatingSchool().size(); schoolIndex ++)
